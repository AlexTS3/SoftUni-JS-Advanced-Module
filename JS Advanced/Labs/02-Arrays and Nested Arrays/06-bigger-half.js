function biggerHalf(numArr) {
    ...
    const index = Math.floor(newArr.length / 2);
    const resultArr = [];
...
// containing only the second half of the input.If there is an
// odd number of elements in the input, always take the bigger half.
// For example, if the input array contains 4 elements, the output
// should be 2, and if the input is 5 – the output is 3.
